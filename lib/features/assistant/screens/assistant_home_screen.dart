...
class AssistantHomeScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final items = <_SubItem>[
      ...
      _SubItem(
        'Эксперименты',
        'Пространство для быстрой проверки работы ассистента: после изменения настроек можно смоделировать нужный диалог и посмотреть, как ассистент отрабатывает шаги, вопросы и логику.',
