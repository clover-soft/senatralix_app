...
class ConnectorEditController extends StateNotifier<ConnectorEditState> {
  ...
  void setGreetingStrategy(String v) => state = state.copy(greetingSelectionStrategy: v);
  void setRepromptTexts(List<String> v) => state = state.copy(repromptTexts: v);
  void setRepromptStrategy(String v) => state = state.copy(repromptSelectionStrategy: v);
  ...
  void setFillerStrategy(String v) => state = state.copy(fillerSelectionStrategy: v);
  ...
  Connector buildResult(Connector initial) => initial.copyWith(
        ...
        settings: ConnectorSettings(
          dialog: ConnectorDialogSettings(
            ...
            repeatPromptOnInterrupt: initial.settings.dialog.repeatPromptOnInterrupt,
            ...
            maxCallDurationFinalText: initial.settings.dialog.maxCallDurationFinalText,
          ),
